...
#   <PolygonLabels name="label" toName="image" strokeWidth="3" pointSize="small" opacity="0.3">
#   <Label value="Mucosa" background="#813d9c"/><Label value="Cartilage" background="#D4380D"/><Label value="Paraglottic Fat" background="#FFC069"/></PolygonLabels>
# </View>